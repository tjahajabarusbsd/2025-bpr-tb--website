...
@section('content')
    ...
    <section class="pt-16">
        <div class="max-w-7xl mx-auto pb-16 px-6">
            <div
                class="bg-white rounded-lg shadow-xl flex flex-col md:flex-row items-center justify-between p-10 border-l-4 border-indigo-600">
                <!-- Konten kiri -->
                <div class="md:w-3/4 mb-6 md:mb-0">
                    ...
                    <p class="text-gray-700 leading-relaxed">
                        PT. BPR (Bank Perkreditan Rakyat) Tjahaja Baru berawal dari akuisisi BPR LPN Magek pada Januari
                        2018,
                ...
                <div class="md:w-1/4 flex justify-center md:justify-end">
                    <a href="/profil"
                        class="px-5 py-2 border border-blue-600 text-blue-600 bg-white rounded-full text-sm font-medium transition hover:bg-blue-600 hover:text-white">
                        Lihat selengkapnya
                    </a>
                </div>
            </div>
    ...
    <section id="products" class="py-20 bg-white">
        <div class="container mx-auto px-6 text-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto text-left">
                <!-- Card: Tabungan -->
                <a href="/tabungan"
                    class="bg-image group bg-gray-50 hover:bg-blue-50 rounded-xl shadow hover:shadow-md hover:scale-[1.03] transition duration-300 p-6 text-center">
                    <img src="{{ url('/images/bpr-tabungan.png') }}" alt="tabungan"
                        class="rounded-lg w-full aspect-square object-cover shadow mb-4" />
                ...
                <a href="/deposito"
                    class="bg-image group bg-gray-50 hover:bg-blue-50 rounded-xl shadow hover:shadow-md hover:scale-[1.03] transition duration-300 p-6 text-center">
                    <img src="{{ url('/images/bpr-deposito.png') }}" alt="deposito"
                        class="rounded-lg w-full aspect-square object-cover shadow mb-4" />
                    <h3 class="text-xl font-semibold mb-2">Deposito</h3>
                    <p class="text-gray-600 text-sm">Investasi berjangka dengan bunga lebih tinggi dan pilihan tenor
                        fleksibel.</p>
                </a>
                ...
                <a href="/kredit"
                    class="bg-image group bg-gray-50 hover:bg-blue-50 rounded-xl shadow hover:shadow-md hover:scale-[1.03] transition duration-300 p-6 text-center">
                    <img src="{{ url('/images/bpr-kredit.png') }}" alt="kreditcard"
                        class="rounded-lg w-full aspect-square object-cover shadow mb-4" />
                    <h3 class="text-xl font-semibold mb-2">Kredit</h3>
                    <p class="text-gray-600 text-sm">Akses pembiayaan cepat dan mudah untuk usaha atau kebutuhan pribadi
                        Anda.</p>
                </a>
            </div>
        </div>
    ...
    <section id="news" class="pb-20 bg-gray-100 text-black overflow-hidden">
        ...
        <div class="container max-w-7xl mx-auto px-4">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-2">
                ...
                <a href="/informasi"
                    class="hidden md:inline-block px-5 py-2 border border-blue-600 text-blue-600 bg-white rounded-full text-sm font-medium transition hover:bg-blue-600 hover:text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @if($mainPost)
                    ...
                    @endphp
                    <a href="{{ url('/informasi/' . $mainPost->category->slug . '/' . $mainPost->slug) }}"
                        class="md:col-span-1 hover:scale-[1.03] transition duration-300 group block">
                ...
                <div class="flex flex-col space-y-4">
                    @foreach($otherPosts as $post)
                        @php
                            ...
                            $firstImage = $matches[1] ?? url('images/dummyimg.jpg');
                        @endphp
                        <a href="{{ url('/informasi/' . $post->category->slug . '/' . $post->slug) }}"
                            class="flex flex-col sm:flex-row items-start gap-4 group hover:scale-[1.03] transition duration-300">
                            <div
                                class="w-full h-64 sm:w-32 sm:h-auto sm:aspect-square bg-gray-300 rounded-lg overflow-hidden shrink-0">
                                <img src="{{ $firstImage }}"
                                    class="w-full h-full object-cover group-hover:opacity-90 transition" />
                            </div>
                            <div class="flex-1">
                                <h4
                                    class="text-sm font-medium line-clamp-3 md:text-md md:font-bold group-hover:text-blue-600 transition-colors">
                                    {{ $post->title }}
                                </h4>
